...
<div id="sidebar" className={sidebarVisible ? 'show' : ''}>
            ...
            <div className="sidebarMenu">
              <Link to={`/dashboard`}>
                <i className="fa-solid fa-user icon"></i> <a>Dashboard</a>
              </Link>
              <Link to={`/dashboard/admin/users`}>
                <i className="fa-solid fa-list icon"></i> <a>List User</a>
              </Link>
              <Link to={`/dashboard/admin/types`}>
                <i className="fa-sharp fa-solid fa-seedling icon"></i> <a>List Tipe Lahan</a>
              </Link>
            </div>
          </div>
          <div className='content'>
            <nav>
            <i className="fas fa-bars toggle-sidebar" onClick={handleToggleSidebar}></i>
              <form action='#'>
